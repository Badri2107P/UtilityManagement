...
<div class="header">
  <a href="index.php" class="logo">GIS System<br/></a>
...
<div class="topnav">
  <a href="home.php">Electric Board</a>
    ...
    <button class="dropbtn">Water Board
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="#" id="water" onclick="demandmanagement();">Demand Management</a>
</div>
</div>
...
function changevillage(value) {
  ...
  <div id="map"></div>
    ...
    <script src="waterboard.js"></script>
  </div>
